  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-1.5 mb-6">
        <h3 className="font-semibold leading-none tracking-tight">Top Influencers</h3>
        <p className="text-sm text-muted-foreground">Highest engagement rates</p>
      </div>
          ...
          influencers.map((influencer, i) => (
            ...
            >
              ...
              <div className="ml-4 space-y-1 flex-1">
                ...
                <p className="text-xs text-muted-foreground">@{influencer.instagramHandle}</p>
              </div>
